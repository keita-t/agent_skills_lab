...
agents use to align context while working in this repository.
...
|---|---|
| project charter | The intentionally minimal document for repository-specific scope and explicit maintainer decisions. |
| ubiquitous language | The shared vocabulary layer maintained for context alignment without becoming a policy surface. |
| documentation update rules | The canonical policy source for stable docs updates. |
| documentation map | The reader-facing index that routes humans and agents to canonical docs. |
| operational backlog | The current TODO and follow-up notes collected in `docs/TODO.md`. |

## Related Documents

- [docs/project-charter.md](./project-charter.md): repository-specific scope
