# Repository Documentation Guide / ドキュメント案内

## English

This file is guidance only. The canonical repository rules and documentation
live under `docs/`.
...
このファイルは案内専用です。正本文書は `docs/` に集約します。

AI が実装や文書更新を行うときは、まず次を読みます。
