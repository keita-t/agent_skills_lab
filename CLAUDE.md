# agent_skills_lab - Documentation Guide / ドキュメント案内

## English

This file is guidance only. The canonical repository rules and stable
documentation live under `docs/`.
...
このファイルは案内専用です。リポジトリの正本文書と安定した運用ルールは `docs/` に集約します。
