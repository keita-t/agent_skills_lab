...
Even when the repository keeps bilingual stable documentation, this TODO may
remain in one primary working language to avoid translation drift.
...
- Replace this line with the next actionable task.

## Unresolved Design Concerns

### Concern Title

Describe the design concern here.

Status: not started
Trace: issue-or-pr-reference

## Resolved Concerns Record

- Move short traces of resolved concerns here.