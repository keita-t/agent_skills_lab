...
2. [docs/ubiquitous-language.md](./ubiquitous-language.md): shared project
  vocabulary that agents may maintain for context alignment.
3. [docs/DOCUMENTATION_UPDATE_RULES.md](./DOCUMENTATION_UPDATE_RULES.md):
  canonical policy for docs structure and TODO protection.
4. [docs/TODO.md](./TODO.md): current backlog and follow-up design notes.

## Current Charter State

- Repository purpose: Replace this line with a short repository-specific
  description.
...
- [docs/ubiquitous-language.md](./ubiquitous-language.md): shared project
