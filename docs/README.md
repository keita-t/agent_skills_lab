# Documentation Map / ドキュメント案内

## English

This directory contains the canonical repository documents for agent_skills_lab.
...
3. [docs/TODO.md](./TODO.md): current backlog and design-review notes.
4. [.github/ECOSYSTEM_REGISTRY.md](../.github/ECOSYSTEM_REGISTRY.md): active
   ecosystem inventory.
5. [.github/AGENT_SKILL_ROUTING.md](../.github/AGENT_SKILL_ROUTING.md):
...
このディレクトリには、agent_skills_lab の正本文書を集約します。
...
3. [docs/TODO.md](./TODO.md): 現在の TODO と設計レビューのメモ。
4. [.github/ECOSYSTEM_REGISTRY.md](../.github/ECOSYSTEM_REGISTRY.md): 有効な ecosystem inventory。
5. [.github/AGENT_SKILL_ROUTING.md](../.github/AGENT_SKILL_ROUTING.md): ecosystem / agent / skill の routing map。
